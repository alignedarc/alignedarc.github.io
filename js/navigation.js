...
(function() {
  ...
  function closeMenu() {
    ...
    const openDropdown = document.querySelector('.nav__dropdown-parent.open');
  ...
  function init() {
    ...
    const dropdownParent = document.querySelector('.nav__dropdown-parent');
    if (dropdownParent) {
      const dropdownToggle = dropdownParent.querySelector(':scope > a');
      if (dropdownToggle) {
